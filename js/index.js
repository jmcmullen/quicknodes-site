...
$(document).ready(function() {
	...
	twitterFetcher.fetch(
		...
		false,
		false,
		console.log("Quicknodes.com v2.0.2"),
		false,
		function(tweets) {
			$("#announcement").html("<i class='fa fa-twitter'></i>" + tweets[0])
		},
		false
	);
	...
	$.get('https://www.quicknodes.com/api/pricing.json', function(data) {
		$('.replace-pricing').each(function() {
			$(this).html('$' + data[$(this).data('product')].addnewdomain['1']);
		});
	})
